...
\todo[inline]{
	...
	Efficiency is mentioned several times (dimensionality reduction, block
	structure, computation) but not really shown. As to computational
	efficiency, no training times, time-complexities are reported...
}
...
\section{Conclusion}
\todo[inline]{limitations subpar performance for bttda possibly attributed to preprocessing  but improved rel to hoda, optimization traded for model selection but with computational expense}
