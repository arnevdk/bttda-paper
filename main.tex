...
% TODO: find 'yield', 'result', 'achieve', 'obtain', 'get'
...
Tucker tensor decomposition and approximation.
Alternatively, the \ac{parafac} methods decompose a tensor in a sum of rank-1
...
balance between maximally extracting relevant features and minimally extractin
irrelevant features.
...
\begin{figure*}[t]
	...
	\caption[A \acs{hoda} backward projection.]{%
		Left: The multilinear \acf{hoda} projection applied to a third-order tensor
...
Hence, activation patterns are found as~\cite{Parra2005, Haufe2014}
\begin{align}
	\left\{\mat{A}^*\right\}
...
\begin{figure}[t]
	...
	\caption{%
		...
		drops or plateaus depending on feature selection effectiveness.
	}
	\label{fig:blocks}
\end{figure}
