...
2) This allows us to introduce \ac{bttda}\footnote{The source code of the
	methods introduced in this work are available at
...
% What are your opinions about this paragraph and its relevance?
...
%	on BCI decoding.
%	On the other hand, fully substantiating this might require extra analysis
...
\end{equation}
whereas \ac{bttda} training and model selection increases this to
\begin{equation}
...
%This hypothesis seems reasonable, but is not substantiated with
...
%	file: \texttt{block\_theta\_results.csv}\\
%	format: \textit{comma-separated values file}
...
\subsection{Time complexity of HODA and BTTDA}
