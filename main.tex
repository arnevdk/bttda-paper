...
better in 7 out of 14 datasets, combined with a moderate increase in grand average \ac{rocauc}
($91.25 > 90.82$).
...
This experiment reveals the model interpretability provided by the forward
modeling step.
To evaluate this, all three proposed models were trained on the combined
subjects in BNCI2014-008.
Hyperparameters were tuned using 5-fold stratified cross-validation with entire-
subject holdouts to determine the best hyperparameter instances for general
cross-subject decoding.
With these hyperparameters, each model was retrained on the full data combined
over all subjects.
