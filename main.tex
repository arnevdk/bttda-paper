...
$\smash{\textstyle{\hat{\ten{X}}^{(B)}=\sum_b^B\ten{G}^{(b)}\mmpr{\mat{U}^{(b)}}}}$,
	...
	\todo[inline]{The inspiration for writing this paper mostly comes from this concept,
		as it was identified as a limitation in my 2022 paper on Kronecker LCMV and subsequently Kronecker LDA. Should this be included in the introduction and brought forward in the problem statement?
		Shifting the focus to this issue and not simply keeping it on tensor methods
		could require substantial extra analysis relating the data covariance structure to the model structure and perfomance.}
