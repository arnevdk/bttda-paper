...
\begin{tikzpicture}[trim axis group left]
	...
	\begin{groupplot}[
		...
		\nextgroupplot[title=Grand-average contrast]
		...
		\nextgroupplot[title={Block 1 contrast},]

		\addplot+[color=red] coordinates {(0.30, -2.5) (0.30, 2.5)};

		\node[coordinate, pin={%
		[pin distance=1mm, inner sep=0.5pt, text depth=0pt] above:{\footnotesize P1}
		}] at (axis cs:0.135,0.95) {};
		\node[coordinate,pin={%
		[pin distance=1mm, inner sep=0.5pt, text depth=0pt, fill=white] below left:{\footnotesize N1}
		}] at (axis cs:0.2175,-1.32) {};
		\node[coordinate, pin={%
		[pin distance=1mm, inner sep=0.5pt, text depth=0pt] right:{\footnotesize N2}
		...
		\nextgroupplot[title={Block 2 contrast}]
		\addplot+[color=red] coordinates {(0.30, -2.5) (0.30, 2.5)};

		\node[coordinate, pin={%
		[pin distance=1mm, inner sep=0.5pt, text depth=0pt, fill=white] above left:{\footnotesize P3a}
		}] at (axis cs:0.2,0.75) {};
		\node[coordinate, pin={%
		[pin distance=1mm, inner sep=0.5pt, text depth=0pt] above right:{\footnotesize P3b}
		}] at (axis cs:0.3,1.15) {};
		...
		\nextgroupplot[title={Reconstructed contrast}]
		\addplot+[color=red] coordinates {(0.30, -2.5) (0.30, 2.5)};
		\drawEvokedTime{rec}

		\nextgroupplot[group/empty plot]
		\addplot graphics[xmin=-0.1, xmax=0.9, ymin=-2.5, ymax=2.5]{figures/interpretability/erp_contrast_rec_topo.png};
	\end{groupplot}
\end{tikzpicture}
