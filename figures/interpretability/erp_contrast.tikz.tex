...
\begin{tikzpicture}[trim axis group left]
	...
	\begin{groupplot}[
		...
		\nextgroupplot[title={Reconstructed contrast ($b=1$)}, extra x ticks={0.3}]
		...
		\node[coordinate, pin={%
		[pin distance=1mm, inner sep=0.5pt, text depth=0pt] below left:{\footnotesize N1}
		...
		\nextgroupplot[title={Reconstructed contrast ($b=2$)}, extra x ticks={0.3}]
		\addplot+[color=red] coordinates {(0.30, -2.5) (0.30, 2.5)};

		\node[coordinate, pin={%
		[pin distance=1mm, inner sep=0.5pt, text depth=0pt] above left:{\footnotesize P3a}
		}] at (axis cs:0.2,0.75) {};
		\node[coordinate, pin={%
